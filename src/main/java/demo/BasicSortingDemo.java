...
/*
 * This is an intro to sorting using Bubble Sort:
 *   sort integers ascending,
 *   sort integers descending,
 *   sort strings alphabetically descending (lexicographically)
 */
public class BasicSortingDemo {
    public static void main(String[] args) {
         ...
         *
         * Since one iteration of the inner loop puts 1 number in the correct
         * position, the inner loop can run one less time for each number placed
         * in the correct position. Can you figure out how to implement that?
         */
